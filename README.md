...
## Conexion por Docker
Alternativamente se puede crear un contenedor de docker en el cual se tiene toda la configuracion solo se debera inicializar y con esto podra acceder a la aplicacion.
